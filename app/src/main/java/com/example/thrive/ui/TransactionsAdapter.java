...
public class TransactionsAdapter extends RecyclerView.Adapter<TransactionsAdapter.VH> {
    ...
    static class VH extends RecyclerView.ViewHolder { TextView note, amount, date; VH(ItemTransactionBinding b){ super(b.getRoot()); note=b.noteTv; amount=b.amountTv; date=b.dateTv; } }
}
